...
using namespace std;
int main() {
    ifstream fin(R"(C:\Desktop\Code\Facultate An I\UniWork\LFA_tema1\resources\input.txt)");
    ofstream fout(R"(C:\Desktop\Code\Facultate An I\UniWork\LFA_tema1\resources\output.txt)");
